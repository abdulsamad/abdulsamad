...
<br />
I'm a Software Engineer specializing in building scalable web applications with modern technologies.
With extensive experience especially in the Frontend, I focus on delivering high-performance web
apps that drive business value.
<br />
I architect and develop robust web applications with a focus on code quality, performance, and user
experience. My expertise spans excellence with React and TypeScript to backend systems with Node.js,
...
- Tech: React, React Router 7, PWA, TypeScript, Node.js, AWS Lambda
  <br />
- [View Code](https://github.com/abdulsamad/polychat) | [Live Demo](https://polychat.abdulsamad.dev)
  <br />
  <br />
